...
public class GameService {
    ...
    private final GameSpecRepository gameSpecRepository;
    ...
    public GameService(HttpServletRequest request) {
        ...
        this.gameSpecRepository = new GameSpecRepository(request);
    }
    ...
    public void addSpecToGame(Game game, GameSpec minimumSpec, GameSpec recommendedSpec){
        game= new Game(minimumSpec,recommendedSpec );
        gameSpecRepository.save(game);
